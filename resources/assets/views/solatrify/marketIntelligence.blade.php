...
<ul class="nav nav-tabs" id="myTab" role="tablist">
  <li class="nav-item active">
    <a class="nav-link" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="false">Market Intelligence</a>
  </li>
  <li class="nav-item">
    <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="true">Design Support</a>
  </li>
  <li class="nav-item">
  ...
  <li class="nav-item">
    <a class="nav-link" id="maintenance-tab" data-toggle="tab" href="#maintenance" role="tab" aria-controls="maintenance" aria-selected="false">Wholesale</a>
  </li>
</ul>
...
<p>As well as providing the desired system schematic, we are also able to collate documentation to support the products utilised within the design so that you are able to pass this onto your customer and reassure them of the quality of the system.
  ...
  <div class="tab-pane" id="settings" role="tabpanel" aria-labelledby="settings-tab">
       <h4 class="heading-title">Find a qualified, reputable installer in your area</h4>
        ...
        <p>We don't install at Solatrify - we supply. We can't replace or repair faulty – we can get you in touch with the people who can and ensure you are satisfied.</p>
...
<p>By completing the online form below with your details we will contact one of our customers in your area who may be able to assist or CALL <a href="telto:09057999054">09057999054</a> or send “installer request” to email to <a href="mailto:hello@solatrify.com">hello@solatrify.com</a>
                  ...
                  <h4 class="text-theme-colored text-uppercase m-0">Let get an Installer for you.</h4>
