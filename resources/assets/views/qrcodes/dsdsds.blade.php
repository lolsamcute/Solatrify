@extends('layouts.dealer')
    ...
    <link rel='stylesheet' href="{{url('/new_intro/theme/css/custom.css') }}">

    <!-- Revolution Slider -->
    <link rel="stylesheet" href="{{url('/new_intro/plugins/rs-plugin/css/settings.css') }}">
...
@foreach ($sector_categorys as $sector_category)
...
<a href='{{url ("/question/{$sector_category->id}") }}'>
<div class="mask"></div>
<img width="340" height="315" src="{!! $sector_category->file !!}" class="scale-with-grid wp-post-image"/></a>
<div class="image_links">
<a href='{{url ("/question/{$sector_category->id}") }}'>{!! $sector_category->name !!}</a>
</div>
</div>
</div>
