...
@foreach ($category->chunk(5) as $categorys)
...
<div class="mask"></div>
<img width="340" height="315" src="../category/upload/{!!$category->file !!}" class="scale-with-grid wp-post-image"/></a>
...
<button onclick="location.href='{{url ("/products/{$category->id}") }}'" class="btn btn-success">{!! $category->name !!}</button>
